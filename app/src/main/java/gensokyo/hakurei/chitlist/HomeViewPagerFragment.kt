...
import gensokyo.hakurei.chitlist.adapters.CHECKOUT_PAGE_INDEX
...
class HomeViewPagerFragment : Fragment() {
    ...
    private val homeViewModel: HomeViewModel by navGraphViewModels(R.id.home_navigation) {
        ...
        val arguments =
            HomeViewPagerFragmentArgs.fromBundle(arguments!!)
        val viewModelFactory =
            HomeViewModelFactory(arguments.userId, dataSource)
        viewModelFactory
    }
