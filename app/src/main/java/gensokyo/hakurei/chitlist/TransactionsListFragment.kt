...
import gensokyo.hakurei.chitlist.adapters.TransactionAdapter
import gensokyo.hakurei.chitlist.adapters.TransactionListener
...
class TransactionsListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter =
            TransactionAdapter(TransactionListener { transactionId ->
