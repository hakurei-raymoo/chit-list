...
class PrepopulateAccounts {
    ...
    private fun initAccounts(accounts: MutableList<Account>) {
        ...
        accounts.add(Account(firstName = "Thomas A.", lastName = "Anderson", passwordHash = "neo".hash()))
        ...
        accounts.add(Account(firstName = "Vito", lastName = "Corleone", passwordHash = "sicily".hash()))
        ...
        accounts.add(Account(firstName = "Beatrix", lastName = "Kiddo", passwordHash = "blackmamba".hash()))
        accounts.add(Account(firstName = "Maximus Decimus", lastName = "Meridius", passwordHash = "rome".hash()))
        accounts.add(Account(firstName = "Django", lastName = "Freeman", passwordHash = "hildi".hash()))
        accounts.add(Account(firstName = "Dorothy", lastName = "Gale", passwordHash = "kansas".hash()))
        accounts.add(Account(firstName = "Leonard", lastName = "Lawrence", passwordHash = "7.62fmj".hash()))
        accounts.shuffle()
    }
